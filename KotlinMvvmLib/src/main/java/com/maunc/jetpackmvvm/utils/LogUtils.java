...
public final class LogUtils {
    ...
    public static void v() {
        printLog(V, LOG_TAG, DEFAULT_MESSAGE);
    }

    public static void v(Object msg) {
        printLog(V, LOG_TAG, msg);
    }
    ...
    public static void d() {
        printLog(D, LOG_TAG, DEFAULT_MESSAGE);
    }

    public static void d(Object msg) {
        printLog(D, LOG_TAG, msg);
    }
    ...
    public static void i() {
        printLog(I, LOG_TAG, DEFAULT_MESSAGE);
    }

    public static void i(Object msg) {
        printLog(I, LOG_TAG, msg);
    }
    ...
    public static void w() {
        printLog(W, LOG_TAG, DEFAULT_MESSAGE);
    }

    public static void w(Object msg) {
        printLog(W, LOG_TAG, msg);
    }
    ...
    public static void e() {
        printLog(E, LOG_TAG, DEFAULT_MESSAGE);
    }

    public static void e(Object msg) {
        printLog(E, LOG_TAG, msg);
    }
    ...
    public static void a() {
        printLog(A, LOG_TAG, DEFAULT_MESSAGE);
    }

    public static void a(Object msg) {
        printLog(A, LOG_TAG, msg);
    }
    ...
    public static void json(String jsonFormat) {
        printLog(JSON, LOG_TAG, jsonFormat);
    }

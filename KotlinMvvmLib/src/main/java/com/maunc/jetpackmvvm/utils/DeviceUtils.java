...
public final class DeviceUtils {
    ...
    public static int getDeviceWidth() {
        return BaseApp.instance.getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getDeviceHeight(boolean isAddStatusBar) {
        int heightPixels = BaseApp.instance.getResources().getDisplayMetrics().heightPixels;
        if (isAddStatusBar) {
            int statusBarHeight = 0;
            int resourceId = BaseApp.instance.getResources().getIdentifier("status_bar_height", "dimen", "android");
            if (resourceId > 0) {
                statusBarHeight = BaseApp.instance.getResources().getDimensionPixelSize(resourceId);
            }
    ...
    public static void setDeviceDarkStatusBar(Activity activity, boolean bDark) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            //修改状态栏颜色只需要这行代码
            activity.getWindow().setStatusBarColor(BaseApp.instance.getResources().getColor(android.R.color.white));//这里对应的是状态栏的颜色，就是style中colorPrimaryDark的颜色
    ...
    public static String getDeviceImei() {
        try {
            TelephonyManager tm = (TelephonyManager)
                    BaseApp.instance.getSystemService(Context.TELEPHONY_SERVICE);
            if (PermissionChecker.checkSelfPermission(BaseApp.instance,
    ...
    public static String getDeviceAndroidId() {
        try {
            return Settings.Secure.getString(BaseApp.instance.getContentResolver(),
    ...
    public static boolean isExistCard() {
        ...
        StorageManager storageManager = (StorageManager) BaseApp.instance.getSystemService(Context.STORAGE_SERVICE);
        try {
